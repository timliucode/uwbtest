...
- 需要兩支支援 UWB 的裝置，分別擔任 Controller 與 Controlee 角色
...
> - **Samsung SM-S9180**（Galaxy S23 Ultra）— BRI 台灣版，OneUI 8.5，Android 14
> - **Samsung SM-N9860**（Galaxy Note20 Ultra）— BRI 台灣版，OneUI 5.1，Android 13
>
...
3. **OOB Exchange**：互相複製對方地址，填入 Channel、Session Key
...
- **Hardware Present = ✓ / API Available = ✗**：硬體存在但系統層停用（可能原因：韌體政策、系統設定、缺少權限）
